    ...
    <footer className="w-full bg-[#111111] text-gray-400 py-12 px-4 sm:px-6 lg:px-8 border-t border-white/5">
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start text-center md:text-left">
          ...
          {/* Columna 3: Iconos Sociales con SVGs Inline */}
          <div className="flex flex-col items-center md:items-end space-y-3 md:pt-1">
            ...
            <div className="flex items-center space-x-3">
              ...
              <a 
                ...
                className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-primary-gold hover:text-slate-950 transition-all duration-200"
                aria-label="Facebook"
              >
              ...
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M23.5 6.2c-.3-1.1-1.1-2-2.2-2.3C19.3 3.5 12 3.5 12 3.5s-7.3 0-9.3.4C1.6 4.2.8 5.1.5 6.2.1 8.2.1 12 .1 12s0 3.8.4 5.8c.3 1.1 1.1 2 2.2 2.3 2 1 9.3 1 9.3 1s7.3 0 9.3-.4c1.1-.3 1.9-1.2 2.2-2.3.4-2 .4-5.8.4-5.8s0-3.8-.4-5.8zM9.5 15.5V8.5l6.5 3.5-6.5 3.5z"/>
                </svg>
              </a>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-600 text-center sm:text-left">
          <div>
            <p>&copy; {currentYear} Iglesia Altar Familiar. Todos los derechos reservados.</p>
          </div>
          <div>
            <p>
              Desarrollado por{' '}
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="text-gray-500 hover:text-primary-gold font-medium transition-colors underline decoration-white/10 hover:decoration-primary-gold/40"
              >
                Indeva Websites
              </a>
            </p>
